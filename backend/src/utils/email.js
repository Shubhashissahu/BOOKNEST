...
// Verify transporter ONCE (not inside function)
transporter.verify((error) => {
  if (error) {
    console.error('❌ Email not connected:', error.message);
  } else {
    console.log('✅ Email server ready — mails will be sent');
  }
});

//  INR formatter (Indian format)
const formatINR = (amt) =>
              ...
              <table width="600" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="padding:28px 32px;">
                    ...
                    <!-- Transaction Details -->
                    <h3 style="font-size:16px;color:#333;margin:0 0 12px;
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                      ...
                      <tr style="background:#f9f9f9;">
                        <td style="padding:10px 14px;color:#888;font-size:13px;width:45%;">
                          Transaction ID
                        </td>
                        <td style="padding:10px 14px;color:#333;font-size:13px;font-weight:bold;">
                          ${transaction.transactionId}
                        </td>
                      </tr>

                      <tr>
                        <td style="padding:10px 14px;color:#888;font-size:13px;">
                          Date
                        </td>
                        <td style="padding:10px 14px;color:#333;font-size:13px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:16px;">
                      <tr>
                        <td style="text-align:right;font-size:18px;font-weight:bold;color:#1976d2;">
                          Total Paid: ${formatINR(transaction.amount)}
                        </td>
                      </tr>
                    </table>
                ...
                <!-- FOOTER -->
                <tr>
                  <td style="background:#f5f5f5;padding:18px;text-align:center;
